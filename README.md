...
1) Situation-Driven-Adversarial-Attacks-main:-
    ...
    - llama.out contains the collection of GPT-4 Judge outputs for our human-readable adversarial full-prompts with situational context.
    - Contains the attack related to the few-shot chain-of-thought technique.
