...
grok_outputs = "grok_outputs_judge_folder"
...
for filename in os.listdir("****/mul_adv/with_adv/ASR"):
        ...
        with open(os.path.join("****/mul_adv/with_adv/ASR", filename), "r") as file1:
                    for line in file1:
                        ...
                        print("data is == ", data)
                        print("data[que] is == ", data['que'])
                        print("data[ans] is == ", data['ans'])

                        question = data['que']
                        response = data['ans']
                        gpt_judge_template = f"""
        ...
        """
                        ...
                        print("gpt_judge_template == ", gpt_judge_template)

                        # prepare the model input
                        prompt = gpt_judge_template
                        ...
                        grok_judge_outputs.append([data['que'], data['ans'], response.content])
                        counter += 1
